...
public class MyBenchmark {
    ...
    @Benchmark
    public void testBubbleSortOptimized(Blackhole blackhole, BenchMarkState state) {
        IntArraySorter sorter = new IntArraySorter(state.data);
    ...
    @Benchmark
    public void testBiSelectionSort(Blackhole blackhole, BenchMarkState state) {
        IntArraySorter sorter = new IntArraySorter(state.data);
        sorter.biSelectionSort();
        blackhole.consume(state.data);
    }

    @Benchmark
    public void testBiSelectionSortV2(Blackhole blackhole, BenchMarkState state) {
        IntArraySorter sorter = new IntArraySorter(state.data);
        sorter.biSelectionSortV2();
        blackhole.consume(state.data);
    }

    @Benchmark
    public void testBiSelectionSortOptimized(Blackhole blackhole, BenchMarkState state) {
        IntArraySorter sorter = new IntArraySorter(state.data);
        sorter.biSelectionSortOptimized();
        blackhole.consume(state.data);
    }
